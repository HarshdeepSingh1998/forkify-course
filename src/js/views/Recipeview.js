...
class RecipeView extends View {
    ...
    errorMessage = 'couldnot load data';
    successMessage = 'happy'
    constructor() {
        super()
    }
    ...
    generateHTML() {
        ...
        <img src='${this.data.imageUrl}' class="recipe__img" />
      ...
      <div class="recipe__details">
        ...
        <div class="recipe__info">
          ...
          <div class="recipe__info-buttons">
            <button class="btn--tiny btn--increase-servings" data-update=${this.data.serving - 1}>
              <svg>
    ...
    handleServingFunction(handler) {
      this.parentElement.addEventListener('click', (e) => {
        const btn = e.target.closest('.btn--tiny');
        if(!btn) return 
        const newServe = +btn.dataset.update;
